INSERT INTO vocaentity (id, spelling, meaning) VALUES
(1,'resume','이력서'),
(2,'applicant','지원자, 신청자'),
(3,'requirement','필요조건, 요건'),
(4,'meet','(필요,요구 등을)만족시키다'),
(5,'qualified','자격있는, 적격의'),
(6,'candidate','후보자, 지원자'),
(7,'confidence','확신, 자신, 신임'),
(8,'highly','매우, 대단히'),
(9,'professional','전문적인, 직업의, 전문가'),
(10,'interview','면접, 면접을 보다'),
(11,'hire','고용하다'),
(12,'training','교육, 훈련'),
(13,'reference','추천서, 참고'),
(14,'position','일자리, 직책, 두다'),
(15, 'fiscal', '재정의, 회계의'),
(16,'impressed','인상 깊게 생각하는, 감명을 받은'),
(17,'excellent','훌륭한'),
(18,'eligible','자격이 있는, 적격의'),
(19,'identify','알아보다, 확인하다'),
(20,'associate','관련시키다'),
(21,'condition','조건'),
(22,'employment','고용'),
(23,'lack','~이 없다, 부족'),
